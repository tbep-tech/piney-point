...
dt <- Sys.Date()
url <- paste('http://tampabay.loboviz.com/cgi-data/nph-data.cgi?node=82&min_date=20210328&max_date=', dt, '&y=salinity,temperature,co2,oxygen,pht,par,pressure&data_format=text')
