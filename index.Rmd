...
Use the variable selection menu on the top to view results for a measured water quality parameter of interest.  The map on the left will show results at locations that have been sampled for the parameter for the selected date.  The date is chosen from the slider on the right.  All points on the map are sized and colored by the range of values in the data for the selected parameter.  Hit the "play" button below the date slider to view a time lapse of data. The data table shows all results for all dates for the selected parameter.
