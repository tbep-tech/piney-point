...
# non-bay stations
nonbay <- c('BH01', 'P Port 2', 'P Port 3', 'PM Out', '20120409-01', 'PPC41', 'P Port 4')
...
column(12,
  ...
  column(9,
    materialSwitch(inputId = 'rmvssta', label = 'Remove stations on land near Piney Point (these may skew results)?', width = '100%')
  )
)
column(12,
  column(3, 
