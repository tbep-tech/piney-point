...
1. You can choose to show all samples or remove those that are on land near Piney Point.  Removing sampling stations on land will typically shift the color and sizing on the map to a narrower range that provides a better representation of impacts in the bay. 
